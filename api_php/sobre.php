...
<main class="wrap">
    <div class="card">
        ...
        <p>Peneirada é uma plataforma web para conectar jovens atletas <br> (a partir de 16 anos) com olheiros e clubes.
           <br> A ideia é democratizar o acesso às peneiras e avaliações, oferecendo visibilidade para talentos de todas as regiões.
        </p>
    </div>
</main>
</body>
